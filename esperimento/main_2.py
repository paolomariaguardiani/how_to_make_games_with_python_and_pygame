...
# - pygame.sprite.LayeredUpdates() # Uses layers to render the sprites
# esample:
# layeredGroup = pygame.sprite.LayeredUpdates()

# Sprites:
mySprite = pygame.sprite.Sprite(visibleGroup)
mySprite.image = pygame.image.load("char1.png")
mySprite.rect = pygame.Rect(200, 200, 100, 100)
mySprite.image = pygame.transform.scale(mySprite.image, mySprite.rect.size)

# Normally layer 0 is for the background,
# layer 1 is for the main game and 2 for the foreground
# layeredGroup.add(mySprite, layer = 1)

otherSprite = pygame.sprite.Sprite(visibleGroup)
otherSprite.image = pygame.image.load("char1.png")
